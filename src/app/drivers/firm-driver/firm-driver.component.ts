...
@Component({
  selector: 'ns-firm-driver',
  templateUrl: './firm-driver.component.html',
  styleUrls: ['./firm-driver.component.css'],
  moduleId: module.id,
})
export class FirmDriverComponent implements OnInit {
...
driverSelected(args: ListViewEventData) {
  ...
  //  var item = this.driverList.find(args.index);
    ...
    this.DataService.activeDriver=item;
    this.routerExtensions.navigate(["drivers/1"]);
